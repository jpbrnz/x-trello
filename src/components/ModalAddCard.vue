<template>
<div>
  <b-button class="btn btn-sm btn-outline-secondary" @click="showModal"><span aria-hidden="true" class="ei ei-plus_alt"></span> <span class="d-none d-sm-inline-block">Card</span></b-button>
